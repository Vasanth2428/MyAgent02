...
*Generated on: 2026-06-04T20:48:04.376664*
...
| CPU readable | PASS | cpu=18.5% |
| Request succeeded | PASS | status=200 |
| Got a non-empty answer | PASS | len=977 chars |
...
| Latency acceptable (<20s) | PASS | latency=5.16s |
...
| Results have real URLs (not mock) | PASS | urls=['https://www.ibm.com/think/topics/retrieval-augmented-generat', 'https://m |
| Results have real content | PASS | content lengths=[1375, 1014, 1172] |
| Latency under 10s | PASS | latency=1.92s |
| Create session | PASS | status=201 |
| Session ID returned | PASS | sid=SID-8279E5D4 |
...
| Stream latency ok (<25s) | PASS | latency=3.21s |
